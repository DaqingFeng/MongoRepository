...
namespace library
{
    ...
    public class MongoOldRepository<T, TKey> : IMongoOldRepository<T, TKey>
        where T : IMongoEntity<TKey>
    {
        ...
        public MongoOldRepository()
            : this(MongoUtilOld<TKey>.GetDefaultConnectionString())
        {
        }
        ...
        public MongoOldRepository(string connectionString)
        {
            this.collection = MongoUtilOld<TKey>.GetCollectionFromConnectionString<T>(connectionString);
        }
        ...
        public MongoOldRepository(string connectionString, string collectionName)
        {
            this.collection = MongoUtilOld<TKey>.GetCollectionFromConnectionString<T>(connectionString, collectionName);
        }
        ...
        public MongoOldRepository(MongoUrl url)
        {
            this.collection = MongoUtilOld<TKey>.GetCollectionFromUrl<T>(url);
        }
        ...
        /// <param name="url">Url to use for connecting to MongoDB.</param>
        /// <param name="collectionName">The name of the collection to use.</param>
        public MongoOldRepository(MongoUrl url, string collectionName)
        {
            this.collection = MongoUtilOld<TKey>.GetCollectionFromUrl<T>(url, collectionName);
        }
    ...
    public class MongoNormalOldRepository<T> : MongoOldRepository<T, String>, IMongoOldRepository<T, String>
        where T : IMongoEntity<String>
    {
        ...
        /// </summary>
        /// <remarks>Default constructor defaults to "MongoServerSettings" key for connectionstring.</remarks>
        public MongoNormalOldRepository()
            : base() { }
        ...
        /// </summary>
        /// <param name="url">Url to use for connecting to MongoDB.</param>
        public MongoNormalOldRepository(MongoUrl url)
            : base(url) { }
        ...
        /// <param name="url">Url to use for connecting to MongoDB.</param>
        /// <param name="collectionName">The name of the collection to use.</param>
        public MongoNormalOldRepository(MongoUrl url, string collectionName)
        ...
        /// </summary>
        /// <param name="connectionString">Connectionstring to use for connecting to MongoDB.</param>
        public MongoNormalOldRepository(string connectionString)
        ...
        /// <param name="connectionString">Connectionstring to use for connecting to MongoDB.</param>
        /// <param name="collectionName">The name of the collection to use.</param>
        public MongoNormalOldRepository(string connectionString, string collectionName)
